                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <form action="MainController" method="post">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="w-100">
                                <p class="mb-0 small font-weight-bold text-dark">TÊN TÀI KHOẢN (6-30 chars)</p>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <div class="mr-3 bg-light rounded p-2 osahan-icon"><i class="mdi mdi-account-outline"></i></div>
                            <div class="w-100">
                                <p class="mb-0 small font-weight-bold text-dark"  >GIỚI TÍNH</p>
                                <input type="radio" id="radio1" name="radio_option" value="1" checked>
                                <label for="radio1">NAM</label>
                                <input type="radio" id="radio2" name="radio_option" value="2">
                                <label for="radio2">NU</label><br>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
