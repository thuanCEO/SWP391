            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="blogchimchaomao.jsp">BÀI VIẾT</a></li>
        ...
        <c:if test="${sessionScope.username != null}">
                    ...
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fs-5 mb-5">
                                ...
                                <span>- 99.000đ</span>
                                <p class="lead">
                                    Combo 1: Dành cho loài chim chào mào gồm có:
                                </p>
                            </div>
                            <ul>
                                <li>
            ...
            <section class="py-5 bg-light">
                <div class="container px-4 px-lg-5 mt-5">
                    <h2 style="color: #36b9cc">COMBO 1: CHIM CHÀO MÀO BAO GỒM :</h2>
                    <p>
                    <ul>
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                    <h1 class="mb-0">Sản Phẩm Liên Hệ </h1>
