    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center" href="ManagerBlogController">
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <c:forEach items="${list}" var="bl" varStatus="counter">
                                        <form action="MainController" method="post">
                                            <tr>
                                                <td>${bl.blogID}</td>
                                                <td><img src="img/bird/${bl.img}" width="80" height="80"</td>
                                                <td>${bl.title}</td>
                                                <td>${bl.content}</td>
                                                <td>${bl.accountID}</td>
                                                <td>${bl.createdDate}</td>
                                                <td>${bl.updatedDate}</td>
                                                <td>${bl.status}</td>
