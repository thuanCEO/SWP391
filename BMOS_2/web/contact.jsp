...
<html lang="zxx">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/elegant-icons_1.css" type="text/css">
        <link rel="stylesheet" href="css/nice-select_1.css" type="text/css">
        <link rel="stylesheet" href="css/jquery-ui.min_1.css" type="text/css">
                        ...
                        <div class="col-lg-12">
                            <div class="header__top__right">
                                <div class="header__top__right__social">
                                    <a href="https://www.facebook.com/profile.php?id=100093038830955"><i class="fa fa-facebook"></i></a>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact__form__title">
                            <h2 style="color: #062c33">ĐỂ LẠI LỜI NHẮN</h2>
                        </div>
                    </div>
                </div>
