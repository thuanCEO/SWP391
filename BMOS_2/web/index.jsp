    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center" href="Showproduct">
                ...
                <c:if test="${sessionScope.username == 'manager'}">
                    <li class="nav-item">
                        <a class="nav-link" href="ManagerProductController">
                            <i class="mdi mdi-book-open"></i>
                            <span>Quan Li San Pham</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ManagerBlogController">
                            <i class="mdi mdi-book-open"></i>
                            <span>Quan Li Blogs</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ManagerAccountController">
                            <i class="mdi mdi-book-open"></i>
                            <span>Quan Li Account</span></a>
                    </li>
                </c:if>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- 
                                     //SHOW THONG TIN CAC LOAI CHIM CANH
                                     //SHOW CAC LOAI THUC AN + THONG TIN CHI TIET LOAI CHIM + ...    
                        -->  
                        <div class="container-fluid">
                            <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                <h5 class="mb-0">THỨC ĂN TỪNG LOÀI </h5>
                            </div>
                        </div>
                        <div class="row">
                            <a href="chimchaomao.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    ...
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM CHÀO MÀO</p>
                                        <p class="small mb-2">
                            ...
                            <a href="chimvet.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/bird/chimvet1.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM VẸT</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">3.8</span> (903)
                                        </p>
                                    </div>
                                </div>
                            </a>
                            <a href="chimchichcheo.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/bird/chimchitcheo.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM CHÍCH CHÒE</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">4.8</span> (873)
                                        </p>
                                    </div>
                                </div>
                            </a>
                            <a href="chimhoami.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/bird/chimhoami.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM HỌA MI</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">3.2</span> (692)
                                        </p>
                                    </div>
                                </div>
                            </a>
                            <a href="chimcugay.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/bird/chimcugay.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM CU GÁY</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">2.8</span> (389)
                                        </p>
                                    </div>
                                </div>
                            </a>
                            <a href="chimsao.jsp" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/bird/chimsao.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">CHIM SÁO</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">4.5</span> (1302)
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <!-- 
                        //SHOW THUC AN THEO LOAI CATORY
                        -->          
                        <div class="container-fluid">
                            <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                <h5 class="mb-0">CÁC LOẠI THỨC ĂN </h5>
                            </div>
                        </div>
                        <div class="row">
                            <a href="ShowCatoryConTrung" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/meal/saugao.png" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">THỨC ĂN LOẠI SÂU (CÔN TRÙNG)</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">0.8</span> (873)
                                        </p>
                                        <p class="mb-0 text-muted d-flex align-items-center"><span class="badge badge-light"><i class="mdi mdi-truck-fast-outline"></i> FREE SHIP</span>
                                        </p>
                                    </div>
                                </div>
                            </a>
                            <a href="ShowCatoryHat" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/meal/HAT.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">THỨC ĂN LOẠI HẠT</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">0.8</span> (873)
                                        </p>
                                        <p class="mb-0 text-muted d-flex align-items-center"><span class="badge badge-light"><i class="mdi mdi-truck-fast-outline"></i> FREE SHIP</span>
                            ...
                            <a href="ShowCatoryCam" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/meal/CAM.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">THỨC ĂN LOẠI CÁM</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">0.8</span> (873)
                                        </p>
                                        <p class="mb-0 text-muted d-flex align-items-center"><span class="badge badge-light"><i class="mdi mdi-truck-fast-outline"></i> FREE SHIP</span>
                            ...
                            <a href="ShowCatoryThucUong" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/drink/nuoc.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">THỨC UỐNG</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">0.8</span> (873)
                                        </p>
                                        <p class="mb-0 text-muted d-flex align-items-center"><span class="badge badge-light"><i class="mdi mdi-truck-fast-outline"></i> FREE SHIP</span>
                            ...
                            <a href="ShowCatoryTraiCay" class="text-dark text-decoration-none col-xl-4 col-lg-12 col-md-12">
                                <div class="bg-white shadow-sm rounded d-flex align-items-center p-1 mb-2 osahan-list">
                                    <img src="img/fruit/FRUIT.jpg" class="img-fluid" width="100px" height="100px">
                                    <div class="mx-3 py-2 w-100">
                                        <p class="mb-2 text-black">LOẠI TRÁI CÂY</p>
                                        <p class="small mb-2">
                                            <i class="mdi mdi-star text-warning mr-1"></i> <span class="font-weight-bold text-dark">0.8</span> (873)
                                        </p>
                                        <p class="mb-0 text-muted d-flex align-items-center"><span class="badge badge-light"><i class="mdi mdi-truck-fast-outline"></i> FREE SHIP</span>
                                ...
                                <section class="py-5">
                                    ...
                                    <div class="container px-4 px-lg-5 mt-5">
                                        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                                            ...
                                            <c:forEach  items="${LIST_PRODUCT}" var="p" begin="0" end="7">
                                                <div class="col mb-5">
                                                    <div class="card h-100">
                                                        <!-- Sale badge-->
                                                        <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Hot</div>
                                                        <!-- Product image-->
                                                        <img class="card-img-top" src="${p.img}" alt="..."  width="100px" height="180px"/>
                                                        <!-- Product details-->
                                                        ...
                                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="ProductDetailedController?iD=${p.productID}">CHI TIẾT</a></div>
                                                        </div>
                                                        <!-- Product actions-->
                                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            ...
                            <div class="container-fluid">
                                <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                    ...
                                    <a href="ShowListBlog" class="small font-weight-bold text-dark">SEE ALL <i class="mdi mdi-chevron-right mr-2"></i></a>
                                </div>
                            </div>
                            <c:forEach  items="${list}" var="bl" begin="0" end="4">
                                <div class="row">
                                    <a class="text-decoration-none col-xl-3 col-md-3 mb-3">
                                        <div class="card" style="width: 18rem; color: black" >
                                            <img class="card-img-top" src="img/bird/${bl.img}" width="300px" height="300px" alt="...">
                                            <div class="card-body">
                                                <h4>${bl.title}</h4>
