    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center" href="ManagerProductController">
                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            <a href="ManagerAccountController" class="btn btn-primary"><span>Manage Account</span></a>
                                            <a href="ManagerBlogController" class="btn btn-primary"><span>Manage BLogs</span></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="pr" varStatus="counter">
                                        <form action="MainController" method="post">
                                            <tr>
                                                ...
                                                <td>${pr.updatedDate}</td>
                                                <td>
                                                    <select name="txt_status">
                                                        <option ${(ac.status == "1") ? "selected" : ""} value="1" >Avaiable</option>
                                                        <option ${(ac.status == "0") ? "selected" : ""} value="0" >Inavaiable</option>
                                                    </select>
                                                </td>
                                                <td>
